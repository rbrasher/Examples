...
public class BoundCameraExample extends SimpleBaseGameActivity implements IAccelerationListener, IOnSceneTouchListener {
	...
	public EngineOptions onCreateEngineOptions() {
		...
		return new EngineOptions(true, ScreenOrientation.LANDSCAPE_FIXED, new RatioResolutionPolicy(CAMERA_WIDTH * 2, CAMERA_HEIGHT * 2), this.mCamera);
	}
	...
	protected void onCreateResources() {
		...
		this.mToggleButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(this.mHUDTexture, this, "toggle_button.png", 0, 0, 2, 1); //256 x 128
	...
	protected Scene onCreateScene() {
		...
		final Rectangle right = new Rectangle(CAMERA_WIDTH - 2, 0, 0, CAMERA_HEIGHT, this.getVertexBufferObjectManager());
