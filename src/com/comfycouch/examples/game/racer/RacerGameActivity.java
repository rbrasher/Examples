package com.comfycouch.examples.game.racer;
...
public class RacerGameActivity extends SimpleBaseGameActivity {
	...
	private static final int CAMERA_WIDTH = RACETRACK_WIDTH * 5;	//64 * 5 = 320
	private static final int CAMERA_HEIGHT = RACETRACK_WIDTH * 3;	//64 * 3 = 192
	...
	protected void onCreateResources() {
		...
		this.mRacetrackTexture = new BitmapTextureAtlas(this.getTextureManager(), 128, 256, TextureOptions.BILINEAR);
		...
		this.mOnScreenControlKnobTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(mOnScreenControlTexture, this, "onscreen_control_knob.png", 128, 0);
	...
	private void initRacetrack() {
		/* Straights */
		{
			...
			/* Bottom Straight */
			this.mScene.attachChild(new Sprite(RACETRACK_WIDTH, CAMERA_HEIGHT - RACETRACK_WIDTH, 3 * RACETRACK_WIDTH, RACETRACK_WIDTH, racetrackVerticalStraightTextureRegion, this.getVertexBufferObjectManager()));
			...
			/* Right Straight */
			final Sprite rightVerticalStraight = new Sprite(CAMERA_WIDTH - RACETRACK_WIDTH, RACETRACK_WIDTH, RACETRACK_WIDTH, CAMERA_WIDTH, racetrackVerticalStraightTextureRegion, this.getVertexBufferObjectManager());
		...
		/* Edges */
		{
			...
			/* Upper Right */
			final Sprite upperRightCurve = new Sprite(CAMERA_WIDTH - RACETRACK_WIDTH, RACETRACK_WIDTH, RACETRACK_WIDTH, CAMERA_WIDTH, racetrackCurveTextureRegion, this.getVertexBufferObjectManager());
			upperRightCurve.setRotation(180);
			this.mScene.attachChild(upperRightCurve);
			
			/* Lower Right */
			final Sprite lowerRightCurve = new Sprite(CAMERA_WIDTH - RACETRACK_WIDTH, CAMERA_HEIGHT - RACETRACK_WIDTH, RACETRACK_WIDTH, CAMERA_WIDTH, racetrackCurveTextureRegion, this.getVertexBufferObjectManager());
			lowerRightCurve.setRotation(270);
			this.mScene.attachChild(lowerRightCurve);
			
			/* Lower Left */
			final Sprite lowerLeftCurve = new Sprite(0, CAMERA_HEIGHT - RACETRACK_WIDTH, RACETRACK_WIDTH, CAMERA_WIDTH, racetrackCurveTextureRegion, this.getVertexBufferObjectManager());
			lowerLeftCurve.attachChild(lowerLeftCurve);
		}
	}
