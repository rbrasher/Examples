...
public class ColorKeyTextureSourceDecoratorExample extends SimpleBaseGameActivity {
	...
	protected void onCreateResources() {
		...
		/* we will remove both the red and green segment of the chromatic circle,
	...
	protected Scene onCreateScene() {
		...
		final Sprite chromaticCircle = new Sprite(centerX - 80, centerY, mChromaticCircleTextureRegion, this.getVertexBufferObjectManager());
